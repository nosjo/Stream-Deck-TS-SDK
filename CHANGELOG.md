...
## [4.0.0](https://github.com/nosjo/Stream-Deck-TS-SDK/compare/v3.3.4...v4.0.0) (2026-01-04)
...
* add action manager ([c989464](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/c989464bd9b2932c078aea28b6a1215d8177efdf))
* add streamdeck+ support ([dcea65d](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/dcea65ddf5433cef818dd08955ff27e0c5ffe946))
* Added setImageFromUrl method ([57971cf](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/57971cfca139323925145407bc2aa8a85458403e))
* exposed controller to allow for detection if its a key or encoder device ([f9ebf81](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/f9ebf81c9bcfb979115a44fee179c940f6ae673f))
* exposed controller to allow for detection if its a key or encoder device ([#21](https://github.com/nosjo/Stream-Deck-TS-SDK/issues/21)) ([7284ed1](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/7284ed1c542ad514b3a51708432ec8771f08f93a))


### Bug Fixes

* global events don't get triggered ([222f7a9](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/222f7a90c7e0bb9c4a0262ca06d4cbfb61791de4))
* isolate npm config for trusted publish ([#37](https://github.com/nosjo/Stream-Deck-TS-SDK/issues/37)) ([250df6a](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/250df6a081d0a4710b88aff633b13266a66b983d))
* set image crossOrigin to `anonymous` to avoid CORS restrictions [skip ci] ([a43585e](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/a43585e78cd6cf34c2c1a82d226cc1de498963f6))
* switch npm publish to OIDC and secure package information ([e4f7aef](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/e4f7aef7dd60587e48ba16ad2b7062abcf880d82))


### Refactors

* add deprecated to few methods ([0e3089b](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/0e3089baca105ee7c2e30891d90dc19b1a150c27))
* changed disableAutosave to disableAutoSave ([efaf48c](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/efaf48c6470dd60e5d6daa2d2f6f3fa90cce6aed))
* Removed everything deprecated ([4d19504](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/4d19504a1684a4068ceb705a85a7bf90a402f83f))


### Documentation

* add CODEOWNERS file ([3c5a095](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/3c5a095e08f8bf8e59f71eb3d13837817ef79236))
* add links to npm and sonarcloud ([565cfbc](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/565cfbcd4b321a628f8dad38d881034d81aeb678))
* update bug_report.md ([64c9afd](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/64c9afd08237ac77335df665d4bc1b6bd6e1e9fd))
* update feature_request.md ([8a65b9f](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/8a65b9f7cefe44d12b97a879d662fd5b50a741e9))
* update readme ([9cae648](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/9cae648f22b75f52583bb25a04907136d3269974))
* updated readme.md ([becc651](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/becc651832f0ba59f6b3aeb60db03f2e8a267f18))
* updated to newest version ([65d7ede](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/65d7ede0f19fee34d7cf3a28d97f10d48978c266))
* updated to newest version ([12acc4e](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/12acc4e6fe4e0dbad156084dea503273b1af24f8))
* updated to newest version ([1381a66](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/1381a6648c33245ad53e716068e61e9bdd138f01))
* updated to newest version ([9b3008e](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/9b3008ee7180aeb8c1d749e4587cdc8ec42f983e))
* updated to newest version ([50daaa1](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/50daaa1ff219851e0549d5e4e83eb10df481d428))
* updated to newest version ([5e28db4](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/5e28db4f595c08e91564d2b5b50e29a0ccee33b4))
* updated to newest version ([db9a6a8](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/db9a6a8dc4b97e6f2a5643364d95c7ed64a5a319))
* updated to newest version ([59fac5c](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/59fac5cc6e1b26e8a168c078699f8f404fae8d6b))
* updated to newest version ([1c19cd7](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/1c19cd7990e9903f2ae2d47bd49ec42cfa8d47f6))
* updated to newest version ([5b74d14](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/5b74d14ba51829e649f91d58fde3b8d1717357b2))
* updated to newest version ([7e81c37](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/7e81c375110dc58e183d705e4110839bd5184477))
* updated to newest version ([b80c2f5](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/b80c2f59f75d49eeaf64781c6ea5ab108a8c72d5))
* updated to newest version ([409a8c1](https://github.com/nosjo/Stream-Deck-TS-SDK/commit/409a8c191d3439b6f98caa4eac3dcd10a0bf69f1))
